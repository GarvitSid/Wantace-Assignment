...
const seedLeads = [
  { 
    captured_at: new Date("2026-06-02T14:20:11Z"), config_version: 3, name: "Ana Ruiz", phone: "+1-614-555-0148", email: "aruiz@example.com", 
    answers: { roof_area: 2100, material: "asphalt_arch", pitch: "medium", layers: "1", stories: "2" }, 
    estimate_low: 21480, estimate_high: 27260 
  },
  { 
    captured_at: new Date("2026-03-18T09:02:44Z"), config_version: 1, name: "Bill Tanner", phone: "+1-614-555-0192", email: "btanner@example.com", 
  ...
  { 
    captured_at: new Date("2026-07-11T18:47:03Z"), config_version: 3, name: "Priya Nair", phone: "+1-614-555-0177", email: "pnair@example.com", 
...
const importData = async () => {
  try {
    ...
    // Safety Check: Only seed if database is completely empty
    const configCount = await Config.countDocuments();
    const leadCount = await Lead.countDocuments();

    if (configCount > 0 || leadCount > 0) {
      console.log('Database already contains data. Seeding aborted to prevent data loss.');
      process.exit(0);
    }
